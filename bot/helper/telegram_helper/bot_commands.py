...
class _BotCommands:
    def __init__(self):
        ...
        # Video Tools and Media Commands
        self.LVidCommand = f'vtl{CMD_SUFFIX}'          # Leech Video Tools
        self.MVidCommand = f'vtm{CMD_SUFFIX}'          # Mirror Video Tools
        self.VideoToolsCommand = [f'vtools{CMD_SUFFIX}', f'videotools{CMD_SUFFIX}']  # Main Video Tools Menu
